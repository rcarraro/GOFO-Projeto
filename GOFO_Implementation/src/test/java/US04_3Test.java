...
public class US04_3Test {
    ...
    public void testaccountMenu() {
        ...
        systemIn.provideLines("2", "test", "Silva","123", "123456", "test@fei.br", "123456789", "SP", "player", "10000", "123", "1", "test@fei.br", "123456", "10", "ateste", "3", "2", "ateste", "3", "5", "monday", "8", "4", "1", "test12@fei.br"); 
        sistema.accountMenu();
    }
